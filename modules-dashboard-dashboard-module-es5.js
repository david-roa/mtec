...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-dashboard-dashboard-module"], {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015ListJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MatListOption_mat_pseudo_checkbox_2_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("state", ctx_r7.selected ? "checked" : "unchecked")("disabled", ctx_r7.disabled);
      }
    }
    ...
    var MatNavList = /*#__PURE__*/function (_MatListMixinBase2) {
      ...
      function MatNavList() {
        ...
        _this4._stateChanges = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        return _this4;
      }
      /**
       * @return {?}
    ...
    var MatList = /*#__PURE__*/function (_MatListMixinBase3) {
      ...
      function MatList(_elementRef) {
        ...
        _this5._stateChanges = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();

        if (_this5._getListType() === 'action-list') {
    ...
    var MatListItem = /*#__PURE__*/function (_MatListItemMixinBase2) {
      ...
      function MatListItem(_element, _changeDetectorRef, navList, list) {
        ...
        _this6._isInteractiveList = false;
        _this6._destroyed = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        _this6._disabled = false;
        _this6._isInteractiveList = !!(navList || list && list._getListType() === 'action-list');
        _this6._list = navList || list; // If no type attributed is specified for <button>, set it to "button".
        // If a type attribute is already specified, do nothing.

        /** @type {?} */

        var element = _this6._getHostElement();
        ...
        if (_this6._list) {
          ...
          _this6._list._stateChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(_this6._destroyed)).subscribe(
          /**
          * @return {?}
          */
          function () {
    ...
    var MatListOption = /*#__PURE__*/function (_MatListOptionMixinBa) {
      ...
      function MatListOption(_element, _changeDetector, selectionList) {
        ...
        _this7.selectionList = selectionList;
        ...
        _this7.checkboxPosition = 'after';
        /**
         * This is set to true after the first OnChanges cycle so we don't clear the value of `selected`
         * in the first cycle.
         */

        _this7._inputsInitialized = false;
        return _this7;
      }
      /**
      ...
      _createClass(MatListOption, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function (value) {
            return list.compareWith(value, _this8._value);
          })) {
          ...
          */
          function () {
            if (_this8._selected || wasSelected) {
              _this8.selected = true;

              _this8._changeDetector.markForCheck();
            }
          });
    ...
    var MatSelectionList = /*#__PURE__*/function (_MatSelectionListMixi) {
      ...
      tabIndex, _changeDetector) {
        ...
        _this10._multiple = true;
        _this10._contentInitialized = false;
        /**
         * Emits a change event whenever the selected state of an option changes.
         */

        _this10.selectionChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        /**
        ...
        */
        ...
        _this10.selectedOptions = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_7__["SelectionModel"](_this10._multiple);
        /**
      ...
      _createClass(MatSelectionList, [{
        ...
        value: function _setOptionsFromValues(values) {
          ...
          */
          function (value) {
            /** @type {?} */
            var correspondingOption = _this12.options.find(
            /**
            * @param {?} option
            * @return {?}
            */
            function (option) {
              ...
              return option.selected ? false : _this12.compareWith(option.value, value);
            });
        ...
        value: function _allowFocusEscape() {
          ...
          */
          function () {
            ...
            _this13._changeDetector.markForCheck();
          });
        }
        /**
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015MenuJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function _MatMenu_ng_template_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("keydown", function _MatMenu_ng_template_0_Template_div_keydown_0_listener($event) {
          ...
          return ctx_r44._handleKeydown($event);
          ...
          return ctx_r46.closed.emit("click");
          ...
          return ctx_r47._onAnimationStart($event);
          ...
          return ctx_r48._onAnimationDone($event);
        });
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("id", ctx_r43.panelId)("ngClass", ctx_r43._classList)("@transformMenu", ctx_r43._panelAnimationState);

        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵattribute"]("aria-label", ctx_r43.ariaLabel || null)("aria-labelledby", ctx_r43.ariaLabelledby || null)("aria-describedby", ctx_r43.ariaDescribedby || null);
      }
    }
    ...
    var MatMenuItem = /*#__PURE__*/function (_MatMenuItemMixinBase2) {
      ...
      function MatMenuItem(_elementRef, document, _focusMonitor, _parentMenu) {
        ...
        _this14._parentMenu = _parentMenu;
        /**
         * ARIA role for the menu item.
         */

        _this14.role = 'menuitem';
        /**
         * Stream that emits when the menu item is hovered.
         */

        _this14._hovered = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        /**
         * Stream that emits when the menu item is focused.
         */

        _this14._focused = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        /**
         * Whether the menu item is highlighted.
         */

        _this14._highlighted = false;
        /**
         * Whether the menu item acts as a trigger for a sub-menu.
         */

        _this14._triggersSubmenu = false;

        if (_focusMonitor) {
          // Start monitoring the element so it gets the appropriate focused classes. We want
          // to show the focus style for menu items only when the focus was not caused by a
          // mouse or touch interaction.
          _focusMonitor.monitor(_this14._elementRef, false);
        }

        if (_parentMenu && _parentMenu.addItem) {
          _parentMenu.addItem(_assertThisInitialized(_this14));
        }

        _this14._document = document;
        return _this14;
      }
      /**
    ...
    var _MatMenuBase = /*#__PURE__*/function () {
      ...
      _createClass(_MatMenuBase, [{
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function () {
            return _this15.closed.emit('tab');
          ...
          */
          function (focusedItem) {
            return _this15._keyManager.updateActiveItem(focusedItem);
          });
        }
        /**
         * @return {?}
        ...
        value: function focusFirstItem() {
          ...
          if (this.lazyContent) {
            ...
            */
            function () {
              return _this16._focusFirstItem(origin);
            });
          } else {
        ...
        value: function _updateDirectDescendants() {
          ...
          */
          function (items) {
            _this17._directDescendantItems.reset(items.filter(
            /**
            * @param {?} item
            * @return {?}
            */
            function (item) {
              return item._parentMenu === _this17;
            }));

            _this17._directDescendantItems.notifyOnChanges();
          });
        }
      }, {
        key: "xPosition",
        ...
        set: function set(classes) {
          ...
          if (previousPanelClass && previousPanelClass.length) {
            ...
            */
            function (className) {
              _this18._classList[className] = false;
            });
          }
          ...
          if (classes && classes.length) {
            ...
            */
            function (className) {
              _this18._classList[className] = true;
            });
    ...
    var MatMenuTrigger = /*#__PURE__*/function () {
      ...
      function MatMenuTrigger(_overlay, _element, _viewContainerRef, scrollStrategy, _parentMenu, _menuItemInstance, _dir, _focusMonitor) {
        ...
        */
        function () {
          return _this19._openedBy = 'touch';
      ...
      _createClass(MatMenuTrigger, [{
            ...
            if (menu.lazyContent) {
              ...
              */
              ...
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(menu.lazyContent._attached)).subscribe({
                ...
                */
                function complete() {
                  return _this21._setIsMenuOpen(false);
                }
              });
            } else {
          ...
          if (this.menu.setPositionClasses) {
            ...
            */
            function (change) {
              ...
              /** @type {?} */
              _this22.menu.setPositionClasses(posX, posY);
            });
          }
        }
        /**
        ...
        value: function _menuClosingActions() {
          ...
          */
          function (active) {
            return active !== _this23._menuItemInstance;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(
          /**
          * @return {?}
          */
          function () {
            return _this23._menuOpen;
        ...
        value: function _handleHover() {
          ...
          */
          function (active) {
            return active === _this24._menuItemInstance && !active.disabled;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["delay"])(0, rxjs__WEBPACK_IMPORTED_MODULE_4__["asapScheduler"])).subscribe(
          /**
          * @return {?}
          */
          function () {
            _this24._openedBy = 'mouse'; // If the same menu is used between multiple triggers, it might still be animating
            // while the new trigger tries to re-open it. Wait for the animation to finish
            // before doing so. Also interrupt if the user moves to another item.

            if (_this24.menu instanceof MatMenu && _this24.menu._isAnimating) {
              // We need the `delay(0)` here in order to avoid
              // 'changed after checked' errors in some cases. See #12194.
              _this24.menu._animationDone.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["delay"])(0, rxjs__WEBPACK_IMPORTED_MODULE_4__["asapScheduler"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(_this24._parentMenu._hovered())).subscribe(
              /**
              * @return {?}
              */
              function () {
                return _this24.openMenu();
              });
            } else {
              _this24.openMenu();
            }
        ...
        set: function set(menu) {
          ...
          if (menu) {
            ...
            */
            function (reason) {
              _this25._destroyMenu(); // If a click closed the menu, we should close the entire chain of nested menus.


              if ((reason === 'click' || reason === 'tab') && _this25._parentMenu) {
                _this25._parentMenu.closed.emit(reason);
              }
            });
          }
        }
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015SidenavJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MatDrawerContainer_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function MatDrawerContainer_div_0_Template_div_click_0_listener() {
          ...
          return ctx_r11._onBackdropClicked();
        });
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵclassProp"]("mat-drawer-shown", ctx_r9._isShowingBackdrop());
      }
    }
    ...
    function MatSidenavContainer_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function MatSidenavContainer_div_0_Template_div_click_0_listener() {
          ...
          return ctx_r15._onBackdropClicked();
        });
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵclassProp"]("mat-drawer-shown", ctx_r13._isShowingBackdrop());
      }
    }
    ...
    var MatDrawerContent = /*#__PURE__*/function (_angular_cdk_scrollin) {
      ...
      function MatDrawerContent(_changeDetectorRef, _container, elementRef, scrollDispatcher, ngZone) {
        ...
        _this26 = _super9.call(this, elementRef, scrollDispatcher, ngZone);
        _this26._changeDetectorRef = _changeDetectorRef;
        _this26._container = _container;
        return _this26;
      }
      /**
       * @return {?}
    ...
    var MatDrawer = /*#__PURE__*/function () {
      ...
      function MatDrawer(_elementRef, _focusTrapFactory, _focusMonitor, _platform, _ngZone, _doc, _container) {
        ...
        */
        function (opened) {
          if (opened) {
            if (_this28._doc) {
              _this28._elementFocusedBeforeDrawerWasOpened =
              /** @type {?} */
              _this28._doc.activeElement;
            }

            _this28._takeFocus();
          } else {
            _this28._restoreFocus();
          }
        });
        /**
        ...
        */
        function () {
          /** @type {?} */
          Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["fromEvent"])(_this28._elementRef.nativeElement, 'keydown').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(
          /**
          * @param {?} event
          * @return {?}
          */
          function (event) {
            return event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["ESCAPE"] && !_this28.disableClose && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["hasModifierKey"])(event);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(_this28._destroyed)).subscribe(
          /**
          * @param {?} event
          * @return {?}
          */
          function (event) {
            return _this28._ngZone.run(
            /**
            * @return {?}
            */
            function () {
        ...
        */
        function (event) {
          ...
          if (toState.indexOf('open') === 0 && fromState === 'void' || toState === 'void' && fromState.indexOf('open') === 0) {
            _this28.openedChange.emit(_this28._opened);
          }
        });
      }
      /**
      ...
      _createClass(MatDrawer, [{
        ...
        value: function _takeFocus() {
          ...
          */
          function (hasMovedFocus) {
            ...
            if (!hasMovedFocus && typeof _this29._elementRef.nativeElement.focus === 'function') {
              _this29._elementRef.nativeElement.focus();
            }
          });
        }
        /**
        ...
        value: function toggle() {
          ...
          */
          function (resolve) {
            _this30.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(
            /**
            * @param {?} open
            * @return {?}
            */
    ...
    var MatDrawerContainer = /*#__PURE__*/function () {
      ...
      function MatDrawerContainer(_dir, _element, _ngZone, _changeDetectorRef, viewportRuler) {
        ...
        if (_dir) {
          ...
          */
          function () {
            _this31._validateDrawers();

            _this31.updateContentMargins();
          });
        ...
        */
        function () {
          return _this31.updateContentMargins();
        });
      ...
      _createClass(MatDrawerContainer, [{
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function (drawer) {
            ...
            _this32._drawers.reset(drawer.filter(
            /**
            * @param {?} item
            * @return {?}
            */
            function (item) {
              return !item._container || item._container === _this32;
            }));

            _this32._drawers.notifyOnChanges();
          });
          ...
          */
          function () {
            ...
            _this32._drawers.forEach(
            /**
            * @param {?} drawer
            * @return {?}
            */
            function (drawer) {
              _this32._watchDrawerToggle(drawer);

              _this32._watchDrawerPosition(drawer);

              _this32._watchDrawerMode(drawer);
            });

            if (!_this32._drawers.length || _this32._isDrawerOpen(_this32._start) || _this32._isDrawerOpen(_this32._end)) {
        ...
        value: function updateContentMargins() {
          ...
          if (left !== this._contentMargins.left || right !== this._contentMargins.right) {
            ...
            */
            function () {
              return _this33._contentMarginChanges.next(_this33._contentMargins);
            });
          }
        }
        /**
        ...
        value: function ngDoCheck() {
          ...
          if (this._autosize && this._isPushed()) {
            ...
            */
            function () {
              return _this34._doCheckSubject.next();
            });
          }
        }
        /**
        ...
        value: function _watchDrawerToggle(drawer) {
          ...
          */
          function (event) {
            ...
            if (event.toState !== 'open-instant' && _this35._animationMode !== 'NoopAnimations') {
              _this35._element.nativeElement.classList.add('mat-drawer-transition');
            }
          ...
          if (drawer.mode !== 'side') {
            ...
            */
            function () {
              return _this35._setContainerClass(drawer.opened);
            });
          }
        }
        /**
        ...
        value: function _watchDrawerPosition(drawer) {
          ...
          */
          function () {
            _this36._ngZone.onMicrotaskEmpty.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(
            /**
            * @return {?}
            */
            function () {
          ...
          */
          function (drawer) {
            if (drawer.position == 'end') {
              if (_this38._end != null) {
                throwMatDuplicatedDrawerError('end');
              }

              _this38._end = drawer;
            } else {
              if (_this38._start != null) {
                throwMatDuplicatedDrawerError('start');
              }

              _this38._start = drawer;
            }
          });
        ...
        value: function _closeModalDrawer() {
          ...
          */
          function (drawer) {
            return drawer && !drawer.disableClose && _this39._canHaveBackdrop(drawer);
          }).forEach(
          /**
          * @param {?} drawer
          * @return {?}
    ...
    var MatSidenav = /*#__PURE__*/function (_MatDrawer) {
      ...
      function MatSidenav() {
        ...
        _this40._fixedInViewport = false;
        _this40._fixedTopGap = 0;
        _this40._fixedBottomGap = 0;
        return _this40;
      }
      /**
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015SnackBarJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SimpleSnackBar_div_2_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](ctx_r49.data.action);
      }
    }
    ...
    var MatSnackBarContainer = /*#__PURE__*/function (_angular_cdk_portal__) {
      ...
      var _super13 = _createSuper(MatSnackBarContainer);
      ...
      function MatSnackBarContainer(_ngZone, _elementRef, _changeDetectorRef, snackBarConfig) {
        ...
        _this43.snackBarConfig = snackBarConfig;
        /**
         * Whether the component has been destroyed.
         */

        _this43._destroyed = false;
        /**
         * Subject for notifying that the snack bar has exited from view.
         */

        _this43._onExit = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
        /**
         * Subject for notifying that the snack bar has finished entering the view.
         */

        _this43._onEnter = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Subject"]();
        /**
         * The state of the snack bar animations.
         */

        _this43._animationState = 'void';
        /**
        ...
        _this43.attachDomPortal =
        /**
        * @param {?} portal
        * @return {?}
        */
        function (portal) {
          _this43._assertNotAttached();

          _this43._applySnackBarClasses();

          return _this43._portalOutlet.attachDomPortal(portal);
      ...
      _createClass(MatSnackBarContainer, [{
        ...
        value: function _completeExit() {
          ...
          */
          function () {
            _this44._onExit.next();

            _this44._onExit.complete();
          });
        }
        /**
        ...
        value: function _animateSnackBar(snackBarRef, config) {
          ...
          */
          function () {
            ...
            if (_this45._openedSnackBarRef == snackBarRef) {
              _this45._openedSnackBarRef = null;
            }
  ...
  function srcAppComponentsDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var src_app_services_authentication_token_token_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/services/authentication/token/token.service */
    "./src/app/services/authentication/token/token.service.ts");
    /* harmony import */


    var src_app_services_authentication_user_user_session_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/services/authentication/user/user-session.service */
    ...
    var src_app_services_utils_shared_shared_interface_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/services/utils/shared/shared-interface.service */
    "./src/app/services/utils/shared/shared-interface.service.ts");
    /* harmony import */
    ...
    function DashboardComponent_mat_nav_list_23_a_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "\xA0Menu no disponible ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function DashboardComponent_mat_nav_list_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-nav-list");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, DashboardComponent_mat_nav_list_23_a_1_Template, 4, 0, "a", 22);
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r33.showItems);
      }
    }

    function DashboardComponent_mat_nav_list_24_a_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r41 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 25);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_mat_nav_list_24_a_1_Template_a_click_0_listener() {
    ...
    function DashboardComponent_mat_nav_list_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-nav-list");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, DashboardComponent_mat_nav_list_24_a_1_Template, 4, 0, "a", 24);
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r34.showItems);
      }
    }
    ...
    function DashboardComponent_button_42_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_button_42_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r43);

          var ctx_r42 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r42.showMenu = true;
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-icon");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "screen_share");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "span");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Habilitar Menu");
    ...
    function DashboardComponent_button_43_Template(rf, ctx) {
      if (rf & 1) {
        var _r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 26);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_button_43_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r45);

          var ctx_r44 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r44.showMenu = false;
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-icon");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "stop_screen_share");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "span");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Desabilitar Menu");
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      function DashboardComponent(router, tokenService, userAuth, userIdleService, sharedInterfaceService, media, dialog) {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function onResize() {
          this.innerHeight = window.innerHeight - 94;
        ...
        value: function ngOnInit() {
          ...
          /** Configuration Inactivity in Application */
          this.userIdleService.startWatching();
          this.userIdleService.onTimerStart().subscribe(function (count) {
            _this46.sharedInterfaceService.putTimeInactivity(count);

            if (count === 1) _this46.openDialog(new _utils_dialog_data__WEBPACK_IMPORTED_MODULE_3__["DialogClass"](401, 'Sesión Próxima a Caducadar', '', 5), false);
          });
          this.userIdleService.onTimeout().subscribe(function () {
            _this46.dialog.closeAll();

            _this46.logout();
          });
          /** Configuration resize application */
        ...
        value: function logout() {
          this.userAuth.deleteUser();
          this.tokenService.deleteToken();
          this.router.navigateByUrl('/signIn');
        }
      }, {
        key: "openDialog",
        value: function openDialog(data, close) {
          this.dialog.open(_shared_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_1__["DialogComponent"], {
            width: '350px',
            data: data,
            disableClose: close
          });
    ...
    DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
      return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_authentication_token_token_service__WEBPACK_IMPORTED_MODULE_5__["TokenService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_authentication_user_user_session_service__WEBPACK_IMPORTED_MODULE_6__["UserSessionService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](angular_user_idle__WEBPACK_IMPORTED_MODULE_7__["UserIdleService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_utils_shared_shared_interface_service__WEBPACK_IMPORTED_MODULE_8__["SharedInterfaceService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_9__["MediaMatcher"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialog"]));
    };
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      hostBindings: function DashboardComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("resize", function DashboardComponent_resize_HostBindingHandler($event) {
      ...
      decls: 48,
      vars: 17,
      consts: [[1, "mat-sidenav", "mat-bg-image-3", 3, "mode", "opened", "closed"], ["snav", ""], ["color", "black", 1, "mat-bxs-toolbar"], [1, "mat-spacer"], ["src", "../../../assets/image/angular-white.svg", "alt", "mtec", 1, "mat-width-sm-50", "animated", "faster", 3, "ngClass"], [1, "animated", "faster", 3, "ngClass"], [1, "mat-ma-70"], [1, "mat-text-center", "mat-bg-image-2", "mat-pt-50", "mat-pb-20", "mat-bxs-toolbar", "color-font-user"], [1, "mat-d-inline", "mat-ali-center"], [1, "mat-fs-70", "icon-user", "animated", "faster", 3, "ngClass"], [1, "mat-mb-0"], [1, "c-grey", "mat-fs-12"], [4, "ngIf"], ["color", "primary", 1, "mat-bxs-toolbar"], ["mat-icon-button", "", 1, "mat-icon-bob", 3, "click"], ["mat-icon-button", "", 1, "mat-wobble-horizontal", 3, "click"], ["mat-icon-button", "", "aria-label", "menu", 1, "mat-icon-push", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", 3, "click", 4, "ngIf"], ["id", "style-1", 1, "scrollbar"], [1, "force-overflow", 3, "ngStyle"], [1, "mat-mf-30"], ["mat-list-item", "", 4, "ngIf"], ["mat-list-item", ""], ["mat-list-item", "", 3, "click", 4, "ngIf"], ["mat-list-item", "", 3, "click"], ["mat-menu-item", "", 3, "click"]],
      template: function DashboardComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("opened", function DashboardComponent_Template_mat_sidenav_opened_2_listener() {
            return ctx.showLogo = true;
          })("closed", function DashboardComponent_Template_mat_sidenav_closed_2_listener() {
            return ctx.showLogo = false;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, " - MTec");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](23, DashboardComponent_mat_nav_list_23_Template, 2, 1, "mat-nav-list", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](24, DashboardComponent_mat_nav_list_24_Template, 2, 1, "mat-nav-list", 12);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](32, " - MTec");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](33, "span", 3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](34, "button", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_Template_button_click_34_listener() {
            return ctx.logout();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](42, DashboardComponent_button_42_Template, 5, 0, "button", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](43, DashboardComponent_button_43_Template, 5, 0, "button", 18);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("mode", ctx.innerWidth < 600 ? "over" : "side");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", ctx.showLogo ? "rotateInDownLeft" : "rotateOutUpLeft");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", ctx.showLogo ? "fadeInLeft" : "fadeOutUp");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", ctx.showLogo ? "flip" : "");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.user ? ctx.user.username : "Nombre", " ");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.user ? ctx.user.entity_name : "Rol", "");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](ctx.user ? ctx.user.email : "correo@mtec.com");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](15, _c0, ctx.innerHeight + "px"));
        }
      },
      directives: [_angular_material_sidenav__WEBPACK_IMPORTED_MODULE_11__["MatSidenavContainer"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_11__["MatSidenav"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_12__["MatToolbar"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgClass"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_14__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgIf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_15__["MatButton"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_16__["MatMenuTrigger"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_16__["_MatMenu"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgStyle"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterOutlet"], _angular_material_list__WEBPACK_IMPORTED_MODULE_17__["MatNavList"], _angular_material_list__WEBPACK_IMPORTED_MODULE_17__["MatListItem"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_16__["MatMenuItem"]],
      styles: [".force-overflow[_ngcontent-%COMP%] {\n  min-height: 450px;\n  max-height: 1440px;\n}\n\n.center[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex: 1;\n}\n\n.icon-user[_ngcontent-%COMP%] {\n  border-radius: 50%;\n  background: #2d323ecc;\n  width: 25% !important;\n  height: 25% !important;\n  margin-bottom: 10px;\n  padding-top: 5px;\n  border-color: red;\n  border: 3px solid #1e2129;\n}\n\n.scrollbar[_ngcontent-%COMP%] {\n  float: left;\n  height: 89%;\n  width: 100%;\n  overflow-y: scroll;\n}\n\n@media (max-width: 800px) {\n  .scrollbar[_ngcontent-%COMP%] {\n    height: 88.5%;\n  }\n}\n\n@media (max-width: 500px) {\n  .scrollbar[_ngcontent-%COMP%] {\n    height: 90%;\n  }\n}\n\n@media (min-width: 1400px) {\n  .scrollbar[_ngcontent-%COMP%] {\n    height: 94%;\n  }\n}\n\n\n\n#style-1[_ngcontent-%COMP%]::-webkit-scrollbar-track {\n  scrollbar-shadow-color: inset 0 0 6px rgba(0, 0, 0, 0.3);\n  border-radius: 10px;\n  background-color: #a7a7a74d;\n}\n\n#style-1[_ngcontent-%COMP%]::-webkit-scrollbar {\n  width: 12px;\n  background-color: #a7a7a74d;\n}\n\n#style-1[_ngcontent-%COMP%]::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  scrollbar-shadow-color: inset 0 0 6px rgba(0, 0, 0, 0.3);\n  background-color: #1e21298c;\n}\n\n.color-font-user[_ngcontent-%COMP%] {\n  background: #626b8482;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardComponent, [{
        ...
        return [{
          ...
          type: src_app_services_authentication_token_token_service__WEBPACK_IMPORTED_MODULE_5__["TokenService"]
        }, {
          type: src_app_services_authentication_user_user_session_service__WEBPACK_IMPORTED_MODULE_6__["UserSessionService"]
        }, {
          type: angular_user_idle__WEBPACK_IMPORTED_MODULE_7__["UserIdleService"]
        }, {
          type: src_app_services_utils_shared_shared_interface_service__WEBPACK_IMPORTED_MODULE_8__["SharedInterfaceService"]
        }, {
  ...
  /***/
  function srcAppComponentsSharedBreadcrumbBreadcrumbComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function BreadcrumbComponent_ng_container_4_button_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        var i_r49 = ctx_r52.index;
        var item_r48 = ctx_r52.$implicit;

        var ctx_r50 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routerLink", i_r49 < ctx_r50.href.split("/").length - 1 ? _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](2, _c0, "/" + item_r48) : _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](4, _c1));
    ...
    function BreadcrumbComponent_ng_container_4_mat_icon_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BreadcrumbComponent_ng_container_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, BreadcrumbComponent_ng_container_4_button_1_Template, 3, 5, "button", 7);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, BreadcrumbComponent_ng_container_4_mat_icon_2_Template, 2, 0, "mat-icon", 8);
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", i_r49 !== 0 && i_r49 !== ctx_r47.href.split("/").length - 1);
    ...
    BreadcrumbComponent.ɵfac = function BreadcrumbComponent_Factory(t) {
      return new (t || BreadcrumbComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]));
    };
    ...
    BreadcrumbComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 4,
      consts: [[1, "mat-ali-center", "mat-d-flex"], ["mat-icon-button", "", 1, "mat-icon-push", 3, "routerLink"], [1, "mat-mb-3", "c-secondary"], [4, "ngFor", "ngForOf"], ["mat-button", "", "disabled", "", 1, "no-link"], [1, "c-CoolGrey11"], [1, "mat-p-initial"], ["mat-button", "", "class", "no-link mat-underline-from-left", 3, "routerLink", 4, "ngIf"], [4, "ngIf"], ["mat-button", "", 1, "no-link", "mat-underline-from-left", 3, "routerLink"], [1, "c-secondary", "mat-fw-bold"]],
      template: function BreadcrumbComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, BreadcrumbComponent_ng_container_4_Template, 3, 2, "ng-container", 3);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx.href.split("/"));

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](ctx.href.split("/")[ctx.href.split("/").length - 1]);
        }
      },
      directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_2__["MatButton"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLink"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_3__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_5__["MatDivider"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"]],
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvc2hhcmVkL2JyZWFkY3J1bWIvYnJlYWRjcnVtYi5jb21wb25lbnQuc2NzcyJ9 */"]
    });
    /*@__PURE__*/
  ...
  function srcAppModulesDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_dialog_dialog_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../shared/dialog/dialog.module */
    "./src/app/modules/shared/dialog/dialog.module.ts");
    /* harmony import */


    var angular_user_idle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! angular-user-idle */
    "./node_modules/angular-user-idle/__ivy_ngcc__/fesm2015/angular-user-idle.js");
    /* harmony import */
    ...
    var _shared_breadcrumb_breadcrumb_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    DashboardModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_dialog_dialog_module__WEBPACK_IMPORTED_MODULE_2__["DialogModule"], angular_user_idle__WEBPACK_IMPORTED_MODULE_3__["UserIdleModule"], _dashboard_routing__WEBPACK_IMPORTED_MODULE_12__["DashboardRoutingModule"], _shared_breadcrumb_breadcrumb_module__WEBPACK_IMPORTED_MODULE_14__["BreadcrumbModule"],
      /* -Material- */
      _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_4__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_5__["MatToolbarModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_6__["MatMenuModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_7__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_9__["MatSnackBarModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_11__["MatButtonModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DashboardModule, {
        declarations: [_components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_13__["DashboardComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_dialog_dialog_module__WEBPACK_IMPORTED_MODULE_2__["DialogModule"], angular_user_idle__WEBPACK_IMPORTED_MODULE_3__["UserIdleModule"], _dashboard_routing__WEBPACK_IMPORTED_MODULE_12__["DashboardRoutingModule"], _shared_breadcrumb_breadcrumb_module__WEBPACK_IMPORTED_MODULE_14__["BreadcrumbModule"],
        /* -Material- */
        _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_4__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_5__["MatToolbarModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_6__["MatMenuModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_7__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_9__["MatSnackBarModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_11__["MatButtonModule"]]
      });
  ...
  function srcAppModulesDashboardDashboardRoutingTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var routes = [{
      path: '',
      component: src_app_components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__["DashboardComponent"],
      children: [{
        path: 'home',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | home-home-module */
          [__webpack_require__.e("default~home-home-module~modules-authentication-login-login-module"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null,
          /*! ../home/home.module */
  ...
  /***/
  function srcAppModulesSharedBreadcrumbBreadcrumbModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_components_shared_breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    BreadcrumbModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      /* -Material- */
      _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_5__["MatDividerModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](BreadcrumbModule, {
        declarations: [src_app_components_shared_breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_7__["BreadcrumbComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"],
        /* -Material- */
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_5__["MatDividerModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"]],
        exports: [src_app_components_shared_breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_7__["BreadcrumbComponent"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BreadcrumbModule, [{
        ...
        args: [{
          ...
          /* -Material- */
          _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_5__["MatDividerModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"]],
          entryComponents: [src_app_components_shared_breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_7__["BreadcrumbComponent"]],
          exports: [src_app_components_shared_breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_7__["BreadcrumbComponent"]]
        }]
      }], null, null);
    })();
